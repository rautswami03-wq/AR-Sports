...
export const PRESET_TOURNAMENTS: Record<string, TournamentTheme> = {
  ...
  wcl_fancode: {
    ...
    badgeBg: '#1c1917',
    teamLabelBg: '#1c1917',
    teamLabelColor: '#fb923c',
    scoreColor: '#fb923c',
    scoreBoxBg: '#292524',
    battersBg: 'rgba(28,25,23,0.95)',
    centerBoxBg: '#7c2d12',
    bowlerBg: '#1c1917',
  ...
  cricfusion: {
    ...
    badgeBg: '#0e1822',
    teamLabelBg: '#0e1822',
    teamLabelColor: '#22d3ee',
    scoreColor: '#22d3ee',
    scoreBoxBg: '#111f2e',
    battersBg: 'rgba(14,24,34,0.95)',
    centerBoxBg: '#c62828',
    bowlerBg: '#c62828',
