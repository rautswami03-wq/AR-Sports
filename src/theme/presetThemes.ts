...
export const PRESET_TOURNAMENTS: Record<string, TournamentTheme> = {
  ...
  thunder: {
    id: 'thunder',
    name: 'THUNDER (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #b91c1c 0%, #111827 50%, #b91c1c 100%)',
    ...
    centerBoxBg: '#111827',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#111827]',
    scoreBugAccentBg: 'bg-[#b91c1c]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'explosive-gold',
    showOverDots: true,
  ...
  apex: {
    id: 'apex',
    name: 'APEX (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #ec4899 0%, #1e1b4b 50%, #ec4899 100%)',
    primaryAccent: '#f472b6',
    badgeBg: '#1e1b4b',
    teamLabelBg: '#ec4899',
    teamLabelColor: '#ffffff',
    ...
    centerBoxBg: '#1e1b4b',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#1e1b4b]',
    scoreBugAccentBg: 'bg-[#ec4899]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'neon-pulse',
    showOverDots: true,
  ...
  volt: {
    id: 'volt',
    name: 'VOLT (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #06b6d4 0%, #0f172a 50%, #06b6d4 100%)',
    ...
    centerBoxBg: '#0f172a',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#0f172a]',
    scoreBugAccentBg: 'bg-[#06b6d4]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'neon-pulse',
    showOverDots: true,
  ...
  blitz: {
    id: 'blitz',
    name: 'BLITZ (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #dc2626 0%, #0f172a 50%, #fbbf24 100%)',
    primaryAccent: '#fbbf24',
    badgeBg: '#0f172a',
    teamLabelBg: '#dc2626',
    teamLabelColor: '#ffffff',
  ...
  africa: {
    id: 'africa',
    name: 'AFRICA (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #0d9488 0%, #0f172a 50%, #f59e0b 100%)',
  ...
  franchise: {
    id: 'franchise',
    name: 'FRANCHISE (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #991b1b 0%, #1e293b 50%, #991b1b 100%)',
    ...
    centerBoxBg: '#1e293b',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#1e293b]',
    scoreBugAccentBg: 'bg-[#991b1b]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'explosive-gold',
    showOverDots: true,
  ...
  elite: {
    id: 'elite',
    name: 'ELITE (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #15803d 0%, #111827 50%, #b91c1c 100%)',
    primaryAccent: '#22c55e',
    badgeBg: '#111827',
    teamLabelBg: '#15803d',
    teamLabelColor: '#ffffff',
  ...
  aranyaka: {
    id: 'aranyaka',
    name: 'ARANYAKA (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #ea580c 0%, #1c1917 50%, #ea580c 100%)',
    ...
    centerBoxBg: '#1c1917',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#1c1917]',
    scoreBugAccentBg: 'bg-[#ea580c]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'smooth-slide',
    showOverDots: true,
  ...
  shakti: {
    id: 'shakti',
    name: 'SHAKTI (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #1d4ed8 0%, #0f172a 50%, #1d4ed8 100%)',
  ...
  agni: {
    id: 'agni',
    name: 'AGNI (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #7f1d1d 0%, #180808 50%, #eab308 100%)',
    ...
    centerBoxBg: '#180808',
    bowlerBg: '#ffffff',
    scoreBugMainBg: 'bg-[#180808]',
    scoreBugAccentBg: 'bg-[#7f1d1d]',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'crickpro-elite',
    animationVariant: 'explosive-gold',
    showOverDots: true,
  ...
  dharma: {
    id: 'dharma',
    name: 'DHARMA (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #1e293b 0%, #0f172a 50%, #1e293b 100%)',
  ...
  diamond: {
    id: 'diamond',
    name: 'DIAMOND (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #6d28d9 0%, #1e1b4b 50%, #a78bfa 100%)',
  ...
  championship_2022: {
    id: 'championship_2022',
    name: 'CHAMPIONSHIP 2022 (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #1e3a8a 0%, #0f172a 50%, #ef4444 100%)',
    primaryAccent: '#3b82f6',
    badgeBg: '#0f172a',
    teamLabelBg: '#1e3a8a',
    teamLabelColor: '#ffffff',
  ...
  championship_2019: {
    id: 'championship_2019',
    name: 'CHAMPIONSHIP 2019 (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #4c1d95 0%, #0f172a 50%, #22c55e 100%)',
    primaryAccent: '#a78bfa',
    badgeBg: '#0f172a',
    teamLabelBg: '#4c1d95',
    teamLabelColor: '#ffffff',
  ...
  asia_2022: {
    id: 'asia_2022',
    name: 'ASIA 2022 (CRICKPRO)',
    headerGradient: 'linear-gradient(90deg, #0284c7 0%, #0f172a 50%, #eab308 100%)',
    primaryAccent: '#eab308',
    badgeBg: '#0f172a',
    teamLabelBg: '#0284c7',
    teamLabelColor: '#ffffff',
...
export const THEME_ID_MAP: Record<string, string> = {
  ...
  '34': 'dharma',
  '35': 'diamond',
  '36': 'championship_2022',
  '37': 'championship_2019',
  '38': 'asia_2022',
};
