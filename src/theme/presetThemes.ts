...
export const PRESET_TOURNAMENTS: Record<string, TournamentTheme> = {
  ...
  asl26: {
    id: 'asl26',
    name: 'ASTHAVINAYAK PREMIER LEAGUE 2026',
    headerGradient: 'linear-gradient(90deg, #3b0764 0%, #1e1b4b 40%, #1e40af 70%, #eab308 100%)',
    primaryAccent: '#facc15',
    badgeBg: 'linear-gradient(135deg, #3b0764 0%, #1e1b4b 100%)',
    cardBg: '#0c1938',
    cardBorder: '1px solid rgba(250, 204, 21, 0.4)',
    scoreBugMainBg: 'bg-indigo-950',
    scoreBugAccentBg: 'bg-amber-400',
    scoreBugTextColor: 'text-white',
    layoutStyle: 'cricscorer-broadcast',
    animationVariant: 'explosive-gold',
    showOverDots: true,
    showTargetBar: true,
  },
